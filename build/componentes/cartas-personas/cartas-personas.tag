...
<section id="people-section" class=" row text-center pad-top-50 pad-bottom-50" if={ lista } >

<ul each={ x in people } class="push-1-xl col-5-xl push-1-l col-5-l push-1-m col-5-m push-1 col-10">
  <li>
...
<section id="people-mas" class="row text-center pad-top-50 pad-bottom-50" if={ detalles }>


    <button onclick={ toggle } class="push-2-xl col-8-xl push-2-l col-8-l push-2-m col-8-m push-1 col-10">
    <img src={ datos.img } alt={ datos.nombre } class="img-fluid">
    <hr style="border:1px solid white;">

    <h2>{ datos.profesion }</h2>
    <p>{ datos.mensaje }</p>
    <hr style="border:1px solid white;">
    <h6><em>{ datos.nombre }</em></h6>
