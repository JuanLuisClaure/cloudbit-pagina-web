...
<div class="container text-center" style="  border: 2px solid $contrast;
  box-shadow: 0em 0.1em 0.4em #333333;">
  ...
  <div class="row clear">
    ...
    <hr>
      <onscroll>
        <form-contacto class="{ (pos.bottom>-300)? 'si':'no' }"></form-contacto>
      </onscroll>
...
<div class="container text-center pad-top-50">
  <div class="row clear">
    <div class="col-4-xl col-4-l col-4-m col-6">
      <h4><em>DIRECCION</em></h4>
      <hr style="widht:50%; border:1px solid black">
      <p>Calle no me acuerpo #0</p>
    </div>
    <div class="col-4-xl col-4-l col-4-m col-6">
      <h4><em>TELEFONOS</em></h4>
      <hr style="widht:50%; border:1px solid black">
      <p>767563432432</p>
      <p>233433234</p>
    ...
    <div class="col-4-xl col-4-l col-4-m col-6">
      <h4><em>VENTAS</em></h4>
      <hr style="widht:50%; border:1px solid black">
      <p>directo al 674834753</p>
    </div>
    <div class="col-4-xl col-4-l col-4-m col-6">
      <h4><em>GERENCIA</em></h4>
      <hr style="widht:50%; border:1px solid black">
      <p>directo al 455435342</p>
    </div>
    <div class="col-4-xl col-4-l col-4-m col-6">
      <h4><em>POSTULATE</em></h4>
      <hr style="widht:50%; border:1px solid black">
      <p>juanluis@hotmail.com</p>
    </div>
  </div>
</div>
<footer></footer>
