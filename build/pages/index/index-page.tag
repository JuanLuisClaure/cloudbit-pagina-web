...
<section id="index" style={ imagenes } >

<div class="row">

<div class="col-full-xl col-full-l col-full-m col-full text-center">
  <img src="./client/assets/img/cloudbit.png" alt="La mejor empresa de software en Bolivia" class="img-fluid">

</div>
<div class="col-full-xl col-full-l col-full-m col-full text-center">
  <clock h={ h } m={ m } s={ s } ></clock>

</div>
<div class="col-full-xl col-full-l col-full-m col-full text-center">

    <saludos saludos={ saludos } day={ d } ></saludos>
...
// this.mensaje = screen.width+'x'+screen.height
//
// if((screen.width<=360) && (screen.height<=640)){
//   this.mensaje = 'esto es movil'
// }else if ((screen.width<=768) && (screen.height<=1024)) {
//   this.mensaje = 'esto es tablet'
//
// }
</script>
<style>
